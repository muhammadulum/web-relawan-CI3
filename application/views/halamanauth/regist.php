...
<html lang="en">
  <head>
    ...
    <title>RK Tajam Registrasi Admin</title>
...
<link href="<?php echo base_url('assets/');?>bootsrap/css/bootstrap.min.css" rel="stylesheet">
  ...
  <body >
    <form class="form-signin" method="post" action="<?php echo base_url('auth/login/proses_regist');?>">
  <div class="text-center mb-4">
    <img class="mb-4" src="<?php echo base_url('assets/');?>images/logo1.png"  width="120" height="100">
    <h1 class="h3 mb-3 font-weight-normal">Registrasi Admin</h1>
  ...
  <div class="form-label-group">
    <input type="text" id="nama_admin" name="jabatan" class="form-control" placeholder="Nama Admin" required autofocus>
  ...
  <p>sudah ada akun ? <a href="<?php echo base_url("auth/login") ?>">Login disini</a></p>
                </div>
