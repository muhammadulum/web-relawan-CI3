          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-links">
                ...
                <a href="<?php echo base_url('home/detail_namakegiatan/'.$h->id_kegiatan);?>" title="Selengkapnya"><i class="icofont-search-document"></i></a>
              </div>
              <div class="portfolio-info">
                <h4><?php echo $h->nama_kegiatan ?></h4>
                <p><?php echo $h->tahun ?></p>
              </div>
            </div>
          </div>
          <?php endforeach; ?>
