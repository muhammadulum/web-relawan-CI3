          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-links">
                ...
                <a href="<?php echo base_url('home/detail_hasilhutan/'.$h->id_produk);?>" title="Selengkap nya"><i class="icofont-search-document"></i></a>
                <a href="<?php echo base_url('home/pesan/'.$h->id_produk);?>" type="button" title="Hubungi Penjual"><i class="icofont-phone"></i></a>
              </div>
