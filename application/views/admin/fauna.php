          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                ...
                <a type="button" href="<?php echo base_url('admin/fauna/tambahfauna') ?>" class="btn btn-primary">Tambah Data</a>
              </div>
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <?php foreach ($floradanfauna as $ff): ?>
                        <tr>
                          ...
                          <td>
                            <a href="<?php echo base_url('admin/fauna/editfauna/'.$ff->id_fauna);?>" type="button" class="btn btn-primary">Edit</a>

                            <a onclick="deleteConfirm()"
											 href="<?php echo site_url('admin/fauna/deletefauna/'.$ff->id_fauna); ?>" type="button" class="btn btn-danger"> Hapus</a>
