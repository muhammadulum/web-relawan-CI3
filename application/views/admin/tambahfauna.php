				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<h3>Halaman Tambah Flora Fauna</h3>
						</div> 
						...
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url('admin/fauna/fungsitambah') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name" required="required" class="form-control " name="nama_latin">
											</div>
										</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea type="text" id="first-name" required="required" class="form-control " name="ancaman"></textarea>
											</div>
										</div>
